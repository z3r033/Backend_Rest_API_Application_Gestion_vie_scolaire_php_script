...
if($_SERVER['REQUEST_METHOD']=='POST'){
     ...
     $dept = $_POST['dept'];
    $notic_module_id = $_POST['module_id'];
 
   
   //requite pour supprumer
   $requite = "insert into noticification_enseignant(notic_titre,notic_description,departement_id,module_id) VALUES ('$notic_titre','$notic_description','$dept','$notic_module_id')";
